...
public class ViewModelConstructQuest {
    ...
    private final StringProperty categorySelected = new SimpleStringProperty("All categories");
    ...
    //listener sur le choix de category
    private void configListenerCategory(){
        categorySelected.addListener((o, old, newValue) -> {
            if(newValue != null){
                lvQuestions.set(game.getListQuestions(newValue));
                game.changeCategory(newValue);
            }
        });
    }
    ...
    public SimpleListProperty<String> categoriesProperty() {
        return new SimpleListProperty<>(categories);
    }
    ...
    //retourne la category selectionée
    public StringProperty categorySelectedProperty(){
